...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={`${inter.variable} ${geistSans.variable} ${geistMono.variable} bg-background text-primary font-sans antialiased h-screen w-full overflow-hidden flex flex-col selection:bg-indigo-500/20 selection:text-indigo-200`}>
