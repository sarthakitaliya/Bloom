...
8. removeFile(projectId, filename) - remove a file.
9. getLogs(projectId, lines?, path?) - return the last N lines of a log file inside the sandbox (default path: /tmp/dev.log, default lines: 100).
